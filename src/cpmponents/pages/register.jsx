    ...
    return (
        <div className="login-page flex flex-col h-screen border-gray-300 shadow-md rounded-lg  gap-4 p-4 w-1/3 mx-auto h-full">
            ...
            <div className="flex justify-center items-center login-form grid grid-cols-1 gap-4 w-3/4">
                <div>
                    <label className="block text-sm font-medium text-gray-700" htmlFor="username">Full Name</label>
                    <input className="w-full px-4 py-3 border border-gray-300 rounded-xl outline-none focus:ring-2 focus:ring-blue-500" type="text" id="username" name="username" placeholder="Enter your username" />
                </div>
                <div>
                ...
                <div>
                    ...
                    <label className="text-sm text-gray-600" htmlFor="remember">I agree to the Terms and <span className="text-blue-600 hover:text-blue-800">Privacy Policy</span></label>
                </div>
                <div className="mt-4">
                    <button type="submit" className="w-full bg-blue-600 hover:bg-blue-700 text-white py-3 rounded-xl font-semibold transition">Create Account</button>
                </div>
                <div className="flex items-center justify-center gap-2 mt-4">
                    <p className="text-sm text-gray-600">Already have an account? <a href="/login" className="text-blue-600 hover:text-blue-800 font-semibold">Sign In</a></p>
                </div>
            </div>
        </div>
    )
